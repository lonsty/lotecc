...
@click.command()
@click.option('-c', '--conversion', 'conversion',
              default='s2t',
              show_default=True,
              help='Conversion method between Simplified Chinese and '
                   'Traditional Chinese.')
...
@click.option('-o', '--output', 'output',
              default=None,
              help='Output file or directory. The default is the same as '
...
@click.option('--ignore', 'ignore',
              default='.gitignore',
              show_default=True,
              help='Can be a .gitignore syntax file. Also can be one or '
                   'more patterns, separated by commas.')
@click.option('--suffix', 'suffix',
              default=None, show_default=False,
              help='Suffix of output filename, add this to keep both the '
                   'source file and converted file.')
@click.option('--in-enc', 'in_enc',
              default='utf-8',
              show_default=True,
              help='Encoding for input.')
@click.option('--out-enc', 'out_enc',
              default='utf-8',
              show_default=True,
